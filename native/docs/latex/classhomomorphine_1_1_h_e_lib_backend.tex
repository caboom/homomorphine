...
\item 
void \mbox{\hyperlink{classhomomorphine_1_1_h_e_lib_backend_a3ec7bec3476ac21921f518ba7a3ff6b2}{write\+Cipher\+To\+Stream}} (ostream \&stream)
\item 
void \mbox{\hyperlink{classhomomorphine_1_1_h_e_lib_backend_a5baa6ad05fbb23d27c4ec4bb018a8c64}{set\+Cipher}} (string cipher)
\item 
void \mbox{\hyperlink{classhomomorphine_1_1_h_e_lib_backend_a91b1a5b9baa1031addb9fce1e4a05ec0}{read\+Cipher\+From\+Stream}} (istream \&stream)
\item 
void \mbox{\hyperlink{classhomomorphine_1_1_h_e_lib_backend_ae142417734796968fe66c4b6174d2b8a}{encrypt}} (vector$<$ long $>$ values)
\item 
void \mbox{\hyperlink{classhomomorphine_1_1_h_e_lib_backend_a0fc8b8ad698a9816dde898087b6b5c57}{encrypt}} (long value)
\item 
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!readCipherFromStream@{readCipherFromStream}}
\index{readCipherFromStream@{readCipherFromStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!readPublicKeyFromStream@{readPublicKeyFromStream}}
\index{readPublicKeyFromStream@{readPublicKeyFromStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!readSecretKeyFromStream@{readSecretKeyFromStream}}
\index{readSecretKeyFromStream@{readSecretKeyFromStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!writeCipherToStream@{writeCipherToStream}}
\index{writeCipherToStream@{writeCipherToStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!writePublicKeyToStream@{writePublicKeyToStream}}
\index{writePublicKeyToStream@{writePublicKeyToStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
...
\index{homomorphine::HELibBackend@{homomorphine::HELibBackend}!writeSecretKeyToStream@{writeSecretKeyToStream}}
\index{writeSecretKeyToStream@{writeSecretKeyToStream}!homomorphine::HELibBackend@{homomorphine::HELibBackend}}
